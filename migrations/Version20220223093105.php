 ...
 */
final class Version20220223093105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_emploi DROP state');
        $this->addSql('ALTER TABLE publication_news DROP FOREIGN KEY FK_162B189DEA27F702');
        $this->addSql('ALTER TABLE publication_news CHANGE categorie_news_id categorie_news_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE publication_news ADD CONSTRAINT FK_162B189DEA27F702 FOREIGN KEY (categorie_news_id) REFERENCES categorie_news (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_emploi ADD state VARCHAR(50) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE category_name category_name VARCHAR(55) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE publication_news DROP FOREIGN KEY FK_162B189DEA27F702');
        $this->addSql('ALTER TABLE publication_news CHANGE categorie_news_id categorie_news_id INT NOT NULL, CHANGE content content VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE title title VARCHAR(55) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE owner owner VARCHAR(55) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
