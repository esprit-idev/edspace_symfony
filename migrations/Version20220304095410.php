 ...
 */
final class Version20220304095410 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club_pub DROP FOREIGN KEY FK_F9261C9C61190A32');
        $this->addSql('ALTER TABLE club_pub ADD CONSTRAINT FK_F9261C9C61190A32 FOREIGN KEY (club_id) REFERENCES club (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D64961190A32');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D64961190A32 FOREIGN KEY (club_id) REFERENCES club (id) ON DELETE CASCADE');
    }
}
