 ...
 */
final class Version20220225224517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_news ADD category_name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE publication_news DROP categorie_news_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_news DROP category_name');
        ...
        $this->addSql('ALTER TABLE publication_news DROP FOREIGN KEY FK_162B189DB6CFDCA8');
        $this->addSql('ALTER TABLE publication_news ADD categorie_news_id INT DEFAULT NULL, CHANGE content content VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE title title VARCHAR(55) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE owner owner VARCHAR(55) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
