 ...
 */
final class Version20220506090618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE club_pub_likes');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE club_pub_likes (like_id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, pub_id INT NOT NULL, PRIMARY KEY(like_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
