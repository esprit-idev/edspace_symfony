 ...
 */
final class Version20220226202234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_news ADD content VARCHAR(6500) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_news DROP content, CHANGE title title VARCHAR(55) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE owner owner VARCHAR(55) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE comments comments VARCHAR(6500) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
