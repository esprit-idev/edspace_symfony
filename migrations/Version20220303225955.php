 ...
 */
final class Version20220303225955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club CHANGE club_responsable_id club_responsable_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE club DROP FOREIGN KEY FK_B8EE38729F742DA1');
        $this->addSql('ALTER TABLE club CHANGE club_responsable_id club_responsable_id INT DEFAULT NULL');
