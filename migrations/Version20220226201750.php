 ...
 */
final class Version20220226201750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_news ADD likes INT DEFAULT NULL, ADD comments VARCHAR(6500) DEFAULT NULL, ADD vues INT DEFAULT NULL, DROP content');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_news ADD content VARCHAR(5500) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP likes, DROP comments, DROP vues, CHANGE title title VARCHAR(55) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE owner owner VARCHAR(55) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
